...
public class MoreNewShopAdapter extends RecyclerView.Adapter<MoreNewShopAdapter.MoreShopViewHolder>{
    private Context context;
    private List<MoreShopBean.moreCommoditys> mList;
    public MoreNewShopAdapter(Context context, List<MoreShopBean.moreCommoditys> mList) {
    ...
    public MoreShopViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_new_grid_shop,parent,false);
