...
public class SelectProvinceAdapter extends BaseAdapter{
    ...
    public SelectProvinceAdapter(Context context, List<CityInfoBean.ProvinceList> mList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        SelectProvinceViewHolder viewHolder;
        if (convertView == null){
            convertView = LayoutInflater.from(context).inflate(R.layout.item_province_city_area,null);
            viewHolder = new SelectProvinceViewHolder();
            viewHolder.mProvince = convertView.findViewById(R.id.text_province_city_area);
            convertView.setTag(viewHolder);
        }else viewHolder = (SelectProvinceViewHolder) convertView.getTag();
        CityInfoBean.ProvinceList provinceList = mList.get(position);
        viewHolder.mProvince.setText(provinceList.getProvince());
        return convertView;
    }

    class SelectProvinceViewHolder{
        TextView mProvince;
    }
}
