...
public class GetGoodsTimeAdapter extends BaseAdapter{
    private Context context;
    private List<StoreTimeBean.TimeList> mList;
    private int defItem;//声明选中的项

    public GetGoodsTimeAdapter(Context context, List<StoreTimeBean.TimeList> mList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        StoreTimeBean.TimeList mTypeList = mList.get(position);
