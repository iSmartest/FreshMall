...
public class MoneyDecAdapter  extends RecyclerView.Adapter<MoneyDecAdapter. MoneyDecViewHolder>{
    private Context context;
    private List<MyWelletBean.moneyList> mList;
    public MoneyDecAdapter(Context context, List<MyWelletBean.moneyList> mList) {
    ...
    public void onBindViewHolder(MoneyDecViewHolder viewHolder, int position) {
        ...
        if (!TextUtils.isEmpty(moneyList.getMoneySoure())){
            switch (moneyList.getMoneySoure()){
                case "0":
