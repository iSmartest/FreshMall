...
public class UsedAdapter extends BaseAdapter{
    ...
    if (convertView == null){
        ...
        viewHolder.mReduction = convertView.findViewById(R.id.text_item_used_coupon_securities_reduce_price);
        viewHolder.mAllPrice = convertView.findViewById(R.id.text_item_used_coupon_securities_all_price);
        viewHolder.mTime = convertView.findViewById(R.id.text_item_not_coupon_securities_time);
