            ...
            case R.id.text_my_setting_log_out:
                LogOutDialog dialog = new LogOutDialog(MySettingActivity.this, R.string.log_out, new LogOutDialog.OnSureBtnClickListener() {
                    ...
                    public void sure() {
                        ...
                        bundleLogOut.putInt("isSkip", 1);
                        MyApplication.openActivity(context, LoginActivity.class, bundleLogOut);
    ...
    class clearCache implements Runnable {
        ...
        public void run() {
            try {
                ...
                Thread.sleep(3000);
                if (DataCleanManager.getTotalCacheSize(MySettingActivity.this).startsWith("O")) {
